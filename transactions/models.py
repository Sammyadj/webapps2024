...
class MoneyRequest(models.Model):
    requester = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='money_requests_made',
                                  on_delete=models.CASCADE)
    requested_from = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='money_requests_received',
                                       on_delete=models.CASCADE)
