...
class CurrencyConversion(models.Model):
    ...
    from_currency = models.CharField(max_length=3, choices = currency_choices, default='GBP', help_text="Currency code to convert from")
    to_currency = models.CharField(max_length=3, choices = currency_choices, default='USD', help_text="Currency code to convert to")
